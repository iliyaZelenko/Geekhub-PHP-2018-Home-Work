...
Чтобы библиотека работала ее нужно инициализировать:
...
Дальше есть два путя что-бы получить объект драйвера черей который возможно работать с изображениями:
...
Еще в папке `src/Clasess/Color/` есть классы для работы с разными форматами цветов.
...
<!--<code class="language-php special-code code-center">-->
...
<!--<img src="/examples-with-code/php/img/2.jpg" style="max-width: 400px; margin: 0 auto; display: block;">-->
</p>
<div class="block">
<code class="language-php special-code">
